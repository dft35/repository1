...
#By putting student in the paranthesis, you inherrit all the ( name, number ) clasifications.
...
def resell_inv (username, item, amount, sell_by):
  print(f'Hello {username}')
  print(f'Your item: {item} was purchased for ${amount}')
  print(f'You need to sell it by {sell_by}')
  print("Or else you risk a decline in value")
  print()

resell_inv('curiousbermudian', 'HD Packout Box', 129.99, '12/15/2024')
resell_inv('curiousbermudian', 'Microwaves', 482.99, '12/15/2024')

def alien_name(first, last):
  first = first.capitalize()
  last = last.capitalize()
  return first + " " + last

fullName = alien_name('david', 'turkel')
print(fullName)

# Object Oriented Programming

# Attributes are what an object is: name, age, height
# Methods are what an object can do: actions- eat, sleep, make videos

class Inventory:

# Init constructs objects for us

    def __init__(self, retailer, payment, item, price, quantity, market, risk):
    ...
    def add(self):
      print("This object is being added to the inventory")

    def remove(self):
      print("This object is being removed from the inventory")

    def get_inventory(self):
      return self.retailer, self.payment, self.item, self.price, self.quantity, self.market

Inventory1 = Inventory("US MINT", "Truist CC", "Flowing Hair Gold Coin", 3680, 1, "Ebay", "Low")

print(Inventory1)

def getParkingHours():
  hours = int(input("Enter Number of Hours You Will Park: "))
  return hours
